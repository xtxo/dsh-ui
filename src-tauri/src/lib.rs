...
use app::{
    invoke::{
        clear_dock_badge, download_file, increment_dock_badge, open_browser, send_notification,
        set_dock_badge, set_dock_badge_label, set_zoom, update_theme_mode, webview_navigate,
    },
...
pub fn run_app() {
    ...
    app_builder
        ...
        .setup(move |app| {
            ...
            app::backend::start_backend_service_if_needed(app.app_handle(), window.clone());
            set_system_tray(
                app.app_handle(),
                show_system_tray,
