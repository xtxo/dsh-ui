...
前往 [GitHub Releases 页面 (v0.1.9)](https://github.com/xtxo/dsh-ui/releases/tag/v0.1.9) 或直接点击下方直链下载：
...
| **Windows 绿色免安装版（推荐）** | 🟢 [**DeepSeek-Harness-Portable.zip**](https://github.com/xtxo/dsh-ui/releases/download/v0.1.9/DeepSeek-Harness-Portable.zip) | 无需安装，解压后运行 DeepSeek-Harness.exe |
